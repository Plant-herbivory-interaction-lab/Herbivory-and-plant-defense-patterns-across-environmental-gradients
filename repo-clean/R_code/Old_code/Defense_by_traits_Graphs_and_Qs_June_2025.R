...
# Appendix figures ----
## Figure A1 ----
soil.biplot<-PCbiplot(Soil[,-1]) + C_theme

soil_x_latitude<-ggplot()+
  geom_point(data=PCs,aes(Latitude,Soil_PC1),col="red")+
  geom_point(data=PCs,aes(Latitude,Soil_PC2),col="blue")
